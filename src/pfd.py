...
def find_max_len_gs(TPNs, allowed_noise):
    TPMs = []
    majority_ratio = (100 - allowed_noise) / 100.0
...
def find_rules(det_gms, dep_gms, dep_rev_gms, param_config):
    TPs = []
    check = 0
    max_noise = param_config["allowed_noise_delta"]
    ngs_min_recs = param_config["confidence_K"]
    majority_ratio = (100 - max_noise) / 100.0
